...
# Análisis de datos para "¿Quién justifica qué? El papel del sentido de (in)justicia en las justificaciones de violencia en contexto de protesta" - Estudio 1
...
table1::table1(~sj_obrero + sj_ceo + bj + sj_entrevistado | jv_est_2019_factor, data = procjv_conf_nona)
table1::table1(~sj_obrero + sj_ceo + bj + sj_entrevistado | jv_carab1_2019_factor, data = procjv_conf_nona)
table1::table1(~sj_obrero + sj_ceo + bj + sj_entrevistado | jv_carab2_2019_factor, data = procjv_conf_nona)

# Con predictores de trato respétuoso

table1::table1(~sj_obrero + sj_ceo + bj + sj_entrevistado | trato_salud_factor, data = procjv_conf_nona)
table1::table1(~sj_obrero + sj_ceo + bj + sj_entrevistado | trato_carab_factor, data = procjv_conf_nona)

# Con predictores de grupos desventajdos
table1::table1(~sj_obrero + sj_ceo + bj + sj_entrevistado | sexo_factor, data = procjv_conf_nona)

table1::table1(~sj_obrero + sj_ceo + bj + sj_entrevistado | educ_rec_factor, data = procjv_conf_nona)

table1::table1(~sj_obrero + sj_ceo + bj + sj_entrevistado | ingreso_satisfact_factor, data = procjv_conf_nona)
...
prop_index.modelsimp1 <- lm(prop_index ~ sj_ceo, data = procjv_conf_nona)
prop_index.modelsimp2 <- lm(prop_index ~ sj_obrero, data = procjv_conf_nona)
prop_index.modelsimp3 <- lm(prop_index ~ sj_entrevistado, data = procjv_conf_nona)
prop_index.modelsimp4 <- lm(prop_index ~ bj, data = procjv_conf_nona)

sjPlot::tab_model(list(prop_index.modelsimp1,
                       prop_index.modelsimp2,
                       prop_index.modelsimp3,
                       prop_index.modelsimp4), # los modelos estimados
...
prop_index.modelmul1 <- lm(prop_index ~ bj, data = procjv_conf_nona)
prop_index.modelmul2 <- lm(prop_index ~ bj + sj_entrevistado, data = procjv_conf_nona)
prop_index.modelmul3<- lm(prop_index ~ bj + sj_entrevistado + ingreso, data = procjv_conf_nona)
prop_index.modelmul4 <- lm(prop_index ~ bj + sj_entrevistado + educ_rec_factor, data = procjv_conf_nona)
prop_index.modelmul5 <- lm(prop_index ~ bj + sj_entrevistado + sexo_factor, data = procjv_conf_nona)
prop_index.modelmul6 <- lm(prop_index ~ bj + sj_entrevistado + ingreso_satisfact_factor, data = procjv_conf_nona)
prop_index.modelmul7 <- lm(prop_index ~ bj + sj_entrevistado + ingreso + educ_rec_factor + sexo_factor + ingreso_satisfact_factor, data = procjv_conf_nona)
prop_index.modelmul8<- lm(prop_index ~ bj + sj_entrevistado + trato_salud_factor, data = procjv_conf_nona)
prop_index.modelmul9<- lm(prop_index ~ bj + sj_entrevistado + trato_carab_factor, data = procjv_conf_nona)
prop_index.modelmul10<- lm(prop_index ~ bj + sj_entrevistado + trato_salud_factor + trato_carab_factor, data = procjv_conf_nona)
...
prop_index.modelmulpub1 <- lm(prop_index ~ bj, data = procjv_conf_nona)
prop_index.modelmulpub2 <- lm(prop_index ~ bj + sj_entrevistado, data = procjv_conf_nona)
prop_index.modelmulpub3<- lm(prop_index ~ bj + sj_entrevistado + trato_salud_factor, data = procjv_conf_nona)
prop_index.modelmulpub4<- lm(prop_index ~ bj + sj_entrevistado + trato_carab_factor, data = procjv_conf_nona)
prop_index.modelmulpub5<- lm(prop_index ~ bj + sj_entrevistado + trato_salud_factor + trato_carab_factor, data = procjv_conf_nona)
prop_index.modelmulpub6 <- lm(prop_index ~ bj + sj_entrevistado + ingreso + educ_rec_factor + sexo_factor + ingreso_satisfact_factor, data = procjv_conf_nona)
prop_index.modelmulpub7 <- lm(prop_index ~ bj + sj_entrevistado + ingreso + educ_rec_factor + sexo_factor + ingreso_satisfact_factor + edad + pos_pol_factor + frec_marcha_factor + conf_carab_factor + religion_factor, data = procjv_conf_nona)
...
sjPlot::tab_model(list(prop_index.modelmulpub1,
  ...
  string.pred = "Predictores", string.est = "β", title = "Regresiones lineales - Indice de destruccion a la propiedad", file = "../output/tables/prop_index.html") # nombre predictores y símbolo beta en tabla
...
jv_est_2019.modelsimp1 <- clm(jv_est_2019_factor ~ sj_ceo, data = procjv_conf_nona)
jv_est_2019.modelsimp2 <- clm(jv_est_2019_factor ~ sj_obrero, data = procjv_conf_nona)
jv_est_2019.modelsimp3 <- clm(jv_est_2019_factor ~ sj_entrevistado, data = procjv_conf_nona)
...
jv_est_2019.modelmul1 <- clm(jv_est_2019_factor ~ bj, data = procjv_conf_nona)
jv_est_2019.modelmul2 <- clm(jv_est_2019_factor ~ bj + sj_entrevistado, data = procjv_conf_nona)
jv_est_2019.modelmul3<- clm(jv_est_2019_factor ~ bj + sj_entrevistado + ingreso, data = procjv_conf_nona)
jv_est_2019.modelmul4 <- clm(jv_est_2019_factor ~ bj + sj_entrevistado + educ_rec_factor, data = procjv_conf_nona)
jv_est_2019.modelmul5 <- clm(jv_est_2019_factor ~ bj + sj_entrevistado + sexo_factor, data = procjv_conf_nona)
jv_est_2019.modelmul6 <- clm(jv_est_2019_factor ~ bj + sj_entrevistado + ingreso_satisfact_factor, data = procjv_conf_nona)
jv_est_2019.modelmul7 <- clm(jv_est_2019_factor ~ bj + sj_entrevistado + ingreso + educ_rec_factor + sexo_factor + ingreso_satisfact_factor, data = procjv_conf_nona)
jv_est_2019.modelmul8<- clm(jv_est_2019_factor ~ bj + sj_entrevistado + trato_salud_factor, data = procjv_conf_nona)
jv_est_2019.modelmul9<- clm(jv_est_2019_factor ~ bj + sj_entrevistado + trato_carab_factor, data = procjv_conf_nona)
jv_est_2019.modelmul10<- clm(jv_est_2019_factor ~ bj + sj_entrevistado + trato_salud_factor + trato_carab_factor, data = procjv_conf_nona)
...
jv_est_2019.modelmulpub1 <- clm(jv_est_2019_factor ~ bj, data = procjv_conf_nona)
jv_est_2019.modelmulpub2 <- clm(jv_est_2019_factor ~ bj + sj_entrevistado, data = procjv_conf_nona)
jv_est_2019.modelmulpub3<- clm(jv_est_2019_factor ~ bj + sj_entrevistado + trato_salud_factor, data = procjv_conf_nona)
jv_est_2019.modelmulpub4<- clm(jv_est_2019_factor ~ bj + sj_entrevistado + trato_carab_factor, data = procjv_conf_nona)
jv_est_2019.modelmulpub5<- clm(jv_est_2019_factor ~ bj + sj_entrevistado + trato_salud_factor + trato_carab_factor, data = procjv_conf_nona)
jv_est_2019.modelmulpub6 <- clm(jv_est_2019_factor ~ bj + sj_entrevistado + ingreso + educ_rec_factor + sexo_factor + ingreso_satisfact_factor, data = procjv_conf_nona)
jv_est_2019.modelmulpub7 <- clm(jv_est_2019_factor ~ bj + sj_entrevistado + ingreso + educ_rec_factor + sexo_factor + ingreso_satisfact_factor + edad + pos_pol_factor + frec_marcha_factor + conf_carab_factor + religion_factor, data = procjv_conf_nona)
...
sjPlot::tab_model(list(jv_est_2019.modelmulpub1,
  ...
  p.style = "stars", # asteriscos de significación estadística 
  dv.labels = c("Modelo 1", "Modelo 2", "Modelo 3", "Modelo 4", "Modelo 5", "Modelo 6", "Modelo 7"), # etiquetas de modelos o variables dep.
  string.pred = "Predictores", string.est = "β", title = "Regresiones ordinales logit - Justificacion estudiantes tiren piedras", file = "../output/tables/jv_est.html") # nombre predictores y símbolo beta en tabla
...
jv_carab1_2019.modelsimp1 <- clm(jv_carab1_2019_factor ~ sj_ceo, data = procjv_conf_nona)
jv_carab1_2019.modelsimp2 <- clm(jv_carab1_2019_factor ~ sj_obrero, data = procjv_conf_nona)
jv_carab1_2019.modelsimp3 <- clm(jv_carab1_2019_factor ~ sj_entrevistado, data = procjv_conf_nona)
...
jv_carab1_2019.modelmul1 <- clm(jv_carab1_2019_factor ~ bj, data = procjv_conf_nona)
jv_carab1_2019.modelmul2 <- clm(jv_carab1_2019_factor ~ bj + sj_entrevistado, data = procjv_conf_nona)
jv_carab1_2019.modelmul3<- clm(jv_carab1_2019_factor ~ bj + sj_entrevistado + ingreso, data = procjv_conf_nona)
jv_carab1_2019.modelmul4 <- clm(jv_carab1_2019_factor ~ bj + sj_entrevistado + educ_rec_factor, data = procjv_conf_nona)
jv_carab1_2019.modelmul5 <- clm(jv_carab1_2019_factor ~ bj + sj_entrevistado + sexo_factor, data = procjv_conf_nona)
jv_carab1_2019.modelmul6 <- clm(jv_carab1_2019_factor ~ bj + sj_entrevistado + ingreso_satisfact_factor, data = procjv_conf_nona)
jv_carab1_2019.modelmul7 <- clm(jv_carab1_2019_factor ~ bj + sj_entrevistado + ingreso + educ_rec_factor + sexo_factor + ingreso_satisfact_factor, data = procjv_conf_nona)
jv_carab1_2019.modelmul8<- clm(jv_carab1_2019_factor ~ bj + sj_entrevistado + trato_salud_factor, data = procjv_conf_nona)
jv_carab1_2019.modelmul9<- clm(jv_carab1_2019_factor ~ bj + sj_entrevistado + trato_carab_factor, data = procjv_conf_nona)
jv_carab1_2019.modelmul10<- clm(jv_carab1_2019_factor ~ bj + sj_entrevistado + trato_salud_factor + trato_carab_factor, data = procjv_conf_nona)
...
jv_carab1_2019.modelmulpub1 <- clm(jv_carab1_2019_factor ~ bj, data = procjv_conf_nona)
jv_carab1_2019.modelmulpub2 <- clm(jv_carab1_2019_factor ~ bj + sj_entrevistado, data = procjv_conf_nona)
jv_carab1_2019.modelmulpub3<- clm(jv_carab1_2019_factor ~ bj + sj_entrevistado + trato_salud_factor, data = procjv_conf_nona)
jv_carab1_2019.modelmulpub4<- clm(jv_carab1_2019_factor ~ bj + sj_entrevistado + trato_carab_factor, data = procjv_conf_nona)
jv_carab1_2019.modelmulpub5<- clm(jv_carab1_2019_factor ~ bj + sj_entrevistado + trato_salud_factor + trato_carab_factor, data = procjv_conf_nona)
jv_carab1_2019.modelmulpub6 <- clm(jv_carab1_2019_factor ~ bj + sj_entrevistado + ingreso + educ_rec_factor + sexo_factor + ingreso_satisfact_factor, data = procjv_conf_nona)
jv_carab1_2019.modelmulpub7 <- clm(jv_carab1_2019_factor ~ bj + sj_entrevistado + ingreso + educ_rec_factor + sexo_factor + ingreso_satisfact_factor + edad + pos_pol_factor + frec_marcha_factor + conf_carab_factor + religion_factor, data = procjv_conf_nona)
