...
A fin de facilitar la interpretación de las variables independientes, se efectúa un proceso de recodificación para que las tres variables compartan una escala común. Primero, siguiendo los trabajos previos que han utilizado esta variable [@Resh2017; @Sabbagh2018], se multiplican por -1 las evaluaciones de justicia para el entrevistado ($J_{entrevistado}*-1$) y para el obrero ($J_{obrero}*-1$). Esta recodificación permite interpretar todos los valores de la misma manera, donde a mayor valor en el indicador, más injusticia representa. La única diferencia es que, en el caso de la evaluación de injusticia del gerente, esta injusticia se debe a la sobrerecompensa, en cambio, en las evaluaciones para el entrevistado y el obrero, la injusticia se debe a la subrecompensa. Segundo, los valores menores a 0 fueron recodificados a 0. En términos sustantivos, esto implica que se agrupan los casos que evalúan justicia perfecta y los casos que se evalúan a si mismos o los obreros como injustamente sobrerecompensados ($J_{obrero}*-1<0$ y $J_{entrevistado}*-1<0$) o a los gerentes como injustamente subrecompensados ($J_{gerente}<0$). Esta agrupación se justifica en la medida que estos casos corresponden a menos del 3% de la muestra (ver Anexos). En síntesis, las variables que se analizarán son: $J_{gerente}$, $J_{obrero}*-1$ y $J_{entrevistado}*-1$, donde a mayor valor de $J$, mayor es la injusticia que se evalúa.
