...
En la sección de método se detallarán las características de los datos utilizados, las variables que componen el estudio, asi como sus recodificaciones y, por último, las técnicas de análisis que se emplearán para ponera prueba las hipótesis.
